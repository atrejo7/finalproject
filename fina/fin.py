# TODO:# Declare a Grocery_List variable which should keep all the grocery information
# The Grocery_List should contain item, and its priceGrocery_List = []   #[item_name, item_price, item_number]
# boolean to maintain the for loop for the mainrun = True
# Helper functions
######## Input for Int or Float ################
#Todo:
#decalre a Grocery_List variable which should keep all the grocery information 
#the Grocery_list should contain item, and its price
Grocery_list = [] #{[item_name, item_price, item_ number]
#boolean to maintian the for loop for main 
run = True
while(run):
    Grocery_item = []
    item_name = input("grocery item: ")
    item_price = input("item price: ")
    item_Quantity = input("Quantity: ")
    
    Grocery_item.append(item_name)
    Grocery_item.append(item_price)
    Grocery_item.append(item_Quantity)
